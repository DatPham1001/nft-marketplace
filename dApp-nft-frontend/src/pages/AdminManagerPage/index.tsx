...
const AdminManagerPage = ({ params }) => {
    ...
    return (
        ...
        //                     <tr key={admin.walletAddress} style={{ backgroundColor: admin.status === 'N' ? 'grey' : 'white' }}>
        //                         <td>{index + 1}</td>
        //                         <td>{admin.name}</td>
        ...
        //                             <button onClick={() => handleToggleAdminStatus(index)}>
        //                                 {admin.status === 'N' ? 'Activate' : 'Deactivate'}
        //                             </button>
        //                         </td>
        //                     </tr>
        //                 ))}
